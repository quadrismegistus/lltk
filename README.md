...
## Corpora with closed data

LLTK has code which can help you preprocess the data from these corpora, but you'll have to subscribe or purchase the raw data yourself.
...
| CanonFiction   | Long history of fiction (Chadwyck + MarkMark + misc.)                                                                    | Mixed      |            |         | ☂     |       |       |
